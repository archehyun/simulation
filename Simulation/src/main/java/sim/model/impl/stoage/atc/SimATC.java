...
public abstract class SimATC extends SimModel {
	...
	protected ATCMove2 move;
	protected StoageEvent activeEvent;
	...
	public SimATC(SimMain main, String simName, int id, int blockID, float row, float bay, float width, float height, int locationType) {
		super(main, simName, id);
	...
	public float getSpeed() {
		...
		return speed * BlockManager.blockHRate;
	}

	public float getTrollySpeed() {
		return trollySpeed * BlockManager.blockWRate;
	}
	...
	public void setTrollySpeed(float speed) {
		this.trollySpeed = speed;
	}
