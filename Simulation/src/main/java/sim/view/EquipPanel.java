...
public class EquipPanel extends JPanel implements IFMonitor {
	...
	public void updateMonitor(SimEvent message) {
		...
		SimATC atc = (SimATC) message.get("atcItem");
	...
	class SimpleTableModel extends AbstractTableModel {
		...
		public void update(SimATC atcItem) {
			...
			for (int i = 0; i < rowData.length; i++) {
				if (rowData[i][0].equals(atcItem.getName())) {
					rowData[i][0] = atcItem.getName();
			...
			temp[rowData.length][0] = atcItem.getName();
